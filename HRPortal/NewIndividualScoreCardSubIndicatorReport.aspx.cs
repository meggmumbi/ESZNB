...
namespace HRPortal
{
    public partial class NewIndividualScoreCardSubIndicatorReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    String status = Config.ObjNav.FnGenerateIndividualPcSubIndicatorReport(IndividualPCNo);
