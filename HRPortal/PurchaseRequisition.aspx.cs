...
namespace HRPortal
{
    public partial class PurchaseRequisition : System.Web.UI.Page
    {
        ...
        protected void next_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               // String tJobTask = String.IsNullOrEmpty(jobTaskno.SelectedValue.Trim()) ? "" : jobTaskno.SelectedValue.Trim();
                ...
                String status = Config.ObjNav.CreatePurchaseStoreRequisition(empNo, requisitionNo, tLocation, tDescription, 0, tFundCode,tbranch, tJob, "");
        ...
        protected void uploadDocument_Click(object sender, EventArgs e)
        {
            ...
            string customlibraryname = "Kasneb/Purchase Requisition";
        ...
        public string UploadPurchaseRequisition(Stream fs, string sFileName, string sSpSiteRelativeUrl, string sLibraryName, string leaveNo)
        {
            ...
            string parent_folderName = "Kasneb/Purchase Requisition";
        ...
        protected void deleteFile_Click(object sender, EventArgs e)
        {
            ...
            var sharepointUrl = ConfigurationManager.AppSettings["S_URL"]; try
            {
                using (ClientContext ctx = new ClientContext(sharepointUrl))
                {
                    ...
                    var parentFolderName = @"ERP%20Documents/Kasneb/Purchase Requisition/";
