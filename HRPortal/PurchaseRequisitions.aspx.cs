...
namespace HRPortal
{
    public partial class PurchaseRequisitions : System.Web.UI.Page
    {
        ...
        protected void sendApproval_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String status = Config.ObjNav.SendPurchaseRequisitionApproval(Convert.ToString(Session["employeeNo"]), imprestNo);
        ...
        protected void cancelApproval_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String status = Config.ObjNav.CancelRecordApproval((String)Session["employeeNo"], tDocumentNo, "Purchase Requisition");
                String[] info = status.Split('*');
