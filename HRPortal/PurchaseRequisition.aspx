<%@ Page Title="Purchase Requisition" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PurchaseRequisition.aspx.cs" Inherits="HRPortal.PurchaseRequisition" %>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <asp:DropDownList runat="server" ID="location" CssClass="form-control select2" required />
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
        ...
        <div class="panel-body">
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="form-group">
                    ...
                    <asp:DropDownList runat="server" ID="budget" CssClass="form-control select2" OnSelectedIndexChanged="budget_SelectedIndexChanged" AutoPostBack="True" />
                </div>
            </div>
            <div class="col-lg-6 col-sm-6">
                <div class="form-group">
                    ...
                    <%  using (ClientContext ctx = new ClientContext(ConfigurationManager.AppSettings["S_URL"]))
                        {
                            ...
                            foreach (Folder folder in allFolders)
                            {
                                if (folder.Name == "Kasneb")
                                {
                                    ...
                                    {
                                        if (folders.Name == "Purchase Requisition")
                                        {
