    ...
    public partial class StoreRequisitions : System.Web.UI.Page
    {
        ...
        protected void sendApproval_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String status = Config.ObjNav.SendStoreRequisitionApproval(Convert.ToString(Session["employeeNo"]), imprestNo);
        ...
        protected void cancelApproval_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                String status = Config.ObjNav.CancelRecordApproval((String)Session["employeeNo"], tDocumentNo, "store requisition");
                String[] info = status.Split('*');
