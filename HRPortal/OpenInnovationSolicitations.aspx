<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OpenInnovationSolicitations.aspx.cs" Inherits="HRPortal.OpenInnovationSolicitations" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="content container-fluid">
        ...
        <h5><u>Open Innovation Responses</u></h5>
                    ...
                    <table class="table table-striped table-bordered" style="width: 100%" id="example5">
                        ...
                        <tbody>
                            <%
                                ...
                                var innovations = nav.InnovationSolicitation.Where(r => r.Document_Type == "Idea Response" && r.Status == "Open"  && r.Idea_Originator==empNo && r.Portal_Status=="Draft");
                                //var requests = "";
                            ...
                            <tr>
                                ...
                                <td><a href="ResearchandInnovationApplication.aspx?InnovationIdea=<%=innovation.Document_No %>" class="btn btn-success"><i class="fa fa-share m-r-10"></i>Edit</a></td>
