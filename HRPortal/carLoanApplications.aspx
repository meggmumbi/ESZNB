<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="carLoanApplications.aspx.cs" Inherits="HRPortal.carLoanApplications" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <%
        ...
        var salaryAdvance = nav.Payments.Where(r => r.Status != "Released"&& r.Account_No==employeeNo && r.Payment_Type=="Car Loan");
        if (status== "approved")
        {
            myStatus = "Approved";
            salaryAdvance = nav.Payments.Where(r => r.Status == "Released"&& r.Payment_Type=="Car Loan"&&r.Account_No==employeeNo);
        }
    %>
    <div class="panel panel-primary">
        <div class="panel-heading">
            <%=myStatus %>Car Loan Applications
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <%if (advance.Status == "Open")
                            {
                        %>
                        <td><a href="carLoanApplication.aspx?&&applicationNo=<%=advance.No %>" class="btn btn-success">View/Edit</a></td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Send Car Loan Application For Approval</h4>
      </div>
      <div class="modal-body">
          <asp:TextBox runat="server" ID="salaryAdvanceToApprove" type="hidden"/>
          Are you sure you want to send Car Loan Application No <strong id="approveSalaryAdvance"></strong>  for approval ? 
        </div>
      <div class="modal-footer">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Cancel Car Loan Approval</h4>
      </div>
      <div class="modal-body">
          <asp:TextBox runat="server" ID="cancelSallaryAdvanceNo" type="hidden"/> 
          Are you sure you want to cancel approval of  Car Loan Application No <strong id="cancelSalaryAdvance"></strong>? 
        </div>
      <div class="modal-footer">
