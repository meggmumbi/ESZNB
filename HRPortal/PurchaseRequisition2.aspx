<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PurchaseRequisition2.aspx.cs" Inherits="HRPortal.PurchaseRequisition2" %>
                        ...
                        <%  using (ClientContext ctx = new ClientContext(ConfigurationManager.AppSettings["S_URL"]))
                            {
                                ...
                                foreach (Folder folder in allFolders)
                                {
                                    if (folder.Name == "KASNEB")
                                    {
                                        ...
                                        {
                                            if (folders.Name == "Purchase Requisition Header")
                                            {
